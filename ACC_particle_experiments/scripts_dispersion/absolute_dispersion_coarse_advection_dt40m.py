...
meanFile = "ACC_ridge_coarse_1y_locb_tave_fixtemp_with_derivative.nc"
outFile = f"absolute_dispersion_ACC_ridge_coarse_advection_180d_dt{int(dt/60)}m.nc"
...
def create_fieldset(inpath, dataFile, meanFile):
    ...
    U_mean = parcels.Field.from_netcdf(inpath+meanFile, ("U_mean", "UVEL"), {"lon": "XG", "lat": "YG", "depth": "Zl"}, mesh='flat', timestamps=None, allow_time_extrapolation=True, interp_method = 'cgrid_velocity', deferred_load=False)
    V_mean = parcels.Field.from_netcdf(inpath+meanFile, ("V_mean", "VVEL"), {"lon": "XG", "lat": "YG", "depth": "Zl"}, mesh='flat', timestamps=None, allow_time_extrapolation=True, interp_method = 'cgrid_velocity', deferred_load=False)
    W_mean = parcels.Field.from_netcdf(inpath+meanFile, ("W_mean", "WVEL"), {"lon": "XG", "lat": "YG", "depth": "Zl"}, mesh='flat', timestamps=None, allow_time_extrapolation=True, interp_method = 'cgrid_velocity', deferred_load=False)
